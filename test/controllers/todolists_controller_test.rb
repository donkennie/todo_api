...
class TodolistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todolist" do
    assert_difference("Todolist.count") do
      post todolists_url, params: { todolist: { name: @todolist.name, status: @todolist.status } }, as: :json
    end
  ...
  test "should update todolist" do
    patch todolist_url(@todolist), params: { todolist: { name: @todolist.name, status: @todolist.status } }, as: :json
    assert_response :success
  end
